...
BLOG_AUTHOR = "Centre for Drama Arts"  # (translatable)
BLOG_TITLE = "Frakcija Performing Arts Journal"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://frakcija.gitlab.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://frakcija.cdu.hr/"
BLOG_EMAIL = "to-me@mi2.hr"
BLOG_DESCRIPTION = "Digital archive of the Frakcija Performing Arts Journal"  # (translatable)
